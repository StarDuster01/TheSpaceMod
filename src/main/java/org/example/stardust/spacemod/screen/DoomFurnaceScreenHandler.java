...
public class DoomFurnaceScreenHandler extends ScreenHandler {
    ...
    public DoomFurnaceScreenHandler (int syncId, PlayerInventory playerInventory,
                                     BlockEntity blockEntity, PropertyDelegate arrayPropertyDelegate) {
        super(ModScreenHandlers.DOOM_FURNACE_SCREEN_HANDLER, syncId);
        checkSize(((Inventory) blockEntity), 4);
        this.inventory = (Inventory)blockEntity;
        this.propertyDelegate = arrayPropertyDelegate;
        this.blockEntity = ((DoomFurnaceBlockEntity) blockEntity);


        // Telss where the slots are in x and y on the picture overlay
