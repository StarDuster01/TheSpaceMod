...
public class CableScreen extends HandledScreen<CableScreenHandler> {

    private static final Identifier TEXTURE =
            new Identifier(SpaceMod.MOD_ID,"textures/gui/coal_generator_gui.png");


    public CableScreen(CableScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawForeground(DrawContext context, int mouseX, int mouseY) {
        ...
        CableBlockEntity blockEntity = this.handler.getBlockEntity();
        Text text = Text.of("Cable STuff");
